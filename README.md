...
A repository to collect information, templates, and best practices about delineating tree crowns in remote sensing imagery.  <br clear="left"><img style="float: left; padding: 10px 10px 10px 10px;" width="300" src=imgs/cover_shot.png> <img style="float: right; padding: 10px 10px 10px 10px;" width="300" src=imgs/cover_shot_crowns.png><br clear="left">
